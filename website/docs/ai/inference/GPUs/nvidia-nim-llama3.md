...
```bash
cd ai-on-eks/ai/inference/nvidia-nim/nim-client
python3 -m venv .venv
...
```sh
kubectl apply -f ai-on-eks/ai/inference/nvidia-nim/openai-webui-deployment.yaml
```
...
```bash
cd ai-on-eks/ai/inference/nvidia-nim
